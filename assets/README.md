...
Sem `og-image.jpg`, a página continua funcionando normalmente — só falta o visual do preview de compartilhamento. As miniaturas dos vídeos **não dependem de nenhum arquivo em `videos/`** — vêm do próprio YouTube automaticamente, então nunca aparecem quebradas. Os blocos de Patrocinador Master, Patrocinadores e Apoiadores ficam **escondidos automaticamente** enquanto não houver logo cadastrado (ver [CONFIG.md](../CONFIG.md#patrocinadores--patrocinadores)), então não aparece nada quebrado nessa seção também.
